...
var invasionTime = 5 *60 * 1000; //確認蝙蝠魔召喚的時間
var Orbis_btf;
var Boat_to_Orbis;
...
function scheduleNew() {
    ...
    Ellinia_docked.broadcastMessage(CField.boatPacket(true));
    Orbis_Station.broadcastMessage(CField.boatPacket(true));
...
function takeoff() {
    ...
    Ellinia_docked.broadcastMessage(CField.boatPacket(false));
    Orbis_Station.broadcastMessage(CField.boatPacket(false));
	try{
...
function invasion() {
    ...
    if (numspawn == 2) {
        ...
        Boat_to_Orbis.broadcastMessage(CField.boatEffect(1034));
        Boat_to_Ellinia.broadcastMessage(CField.boatEffect(1034));
