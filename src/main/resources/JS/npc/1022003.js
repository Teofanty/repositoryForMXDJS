...
cm.dispose();	
	...
	if (selectedType == 0){ //mineral refine
	    ...
	    var costSet = new Array(3000,3000,3000,3000,3000,3000,3000);
	    ...
	    var costSet = new Array (3000,3000,3000,3000,3000,3000,3000,3000,3000);
	    item = itemSet[selectedItem];
	    mats = matSet[selectedItem];
	    matQty = matQtySet[selectedItem];
	    cost = costSet[selectedItem];
	...
	if (selectedType == 2){ //helmet refine
	    ...
	    var costSet = new Array(3000,3000,3000,3000,3000,3000,3000,3000,3000,2000,3000,2000,2000,4000,4000,5000,8000,10000,12000,15000,20000,25000,30000,30000);
	    item = itemSet[selectedItem];
	    mats = matSet[selectedItem];
	    matQty = matQtySet[selectedItem];
	    cost = costSet[selectedItem];
