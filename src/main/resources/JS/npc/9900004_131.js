...
var ItemId = Array(
        //物品1         物品2    货币    数量
	Array(1302208,4001266,10, "0"),
    Array(1432012,4001266,10, "1"),
	Array(1442024,4001266,10, "2"),
	Array(1412011,4001266,10, "3"),
	Array(1422014,4001266,10, "4"),
    Array(1472032,4001266,10, "4"),
    Array(1332025,4001266,10, "5"),
	Array(1382012,4001266,10, "6"),
	Array(1452022,4001266,10, "7"),
    Array(1462019,4001266,10, "8"),
    Array(1092030,4001266,10, "9"),
	Array(1432011,4001266,10, "9")
        //如需其它道具兑换，请按照此格式自行添置。
        //代码,价格,介绍
        );
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            sl = cm.getPlayer().getItemQuantity(4001266, false);
            StringS = "#b#n   角色剩余:" + sl + " 颗#v4001266#";
