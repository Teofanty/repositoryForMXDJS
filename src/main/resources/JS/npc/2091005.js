...
var belt_points = Array(200, 1800, 4000, 9200, 19000);
...
var type = ii.getInventoryType(belt); //获得装备的类形
var toDrop = ii.randomizeStats(ii.getEquipById(belt)).copy(); // 生成一个Equip类
...
toDrop. setJump(0);//跳跃
toDrop. setUpgradeSlots(3);//可升级次数
