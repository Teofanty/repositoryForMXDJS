        ...
        if (status == 0) {
		   ...
		   //text += "#e#r#L99#累计赞助50元领取: 1张#v4310018#+10W金币#l#n\r\n\r\n"
			...
			//} else if (cm.getczlz()==4) {//判断累积到500元以上 第3个礼包没领取
				text += "#e#r#L8#累计赞助1000元领取: （#v1142219#全属性+10）+10个#v4031456#+（#v2049100##v2340000#各35张）+500W金币#l#n\r\n\r\n"
...
cm.getPlayer().setBossLog('meirisc');//给bosslog记录
		cm.sendOk("兑现成功！获得"+ j*1 + "点卷！每日首冲50多获得2000点券.经验书*2和12小时的#v1122017#\r\n#r赞助比例1点券=100点卷.");
		cm.worldMessage(6,"玩家：["+cm.getName()+"]每日首冲,感谢对梦之岛的支持~");
		cm.dispose();
        ...
        cm.gaincz(+j*0.01);	
		cm.sendOk("兑现成功！获得"+ j*1 + "点卷！每日首冲20多获得2000点券和经验书*2\r\n#r赞助比例1点券=100点卷.");
		cm.worldMessage(6,"感谢玩家：["+cm.getName()+"]对梦之岛的支持~么么哒");
		cm.dispose();			
			}
		...
		return;
			...
			if (cm.getInventory(4).isFull(0)){
				...
				cm.dispose();
			} else if (cm.getczlz()!=4) {//判断累积到 第一个礼包没领取
				cm.sendOk("已经领取过了！\r\n当前赞助："+cm.getcz()+"元");
				cm.dispose();
			} else{
				cm.setczlz(1);//给记录
