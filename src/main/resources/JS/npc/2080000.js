    ...
    if (status == -1) {
        ...
        if (bustedDagger) {
            ...
            if (selectedType == 0) { //What's a stim?
				if (cm.getInventory(4).isFull(0)){//判断第4个也就是其它栏的装备栏是否有一个空格
                cm.sendOk("#b请保证其它栏位至少有1个空格,否则无法制作.");	
                cm.dispose();	
                } else{
				...
				if (cm.getInventory(1).isFull(0)){//判断第4个也就是其它栏的装备栏是否有一个空格
					cm.sendOk("#b请保证装备栏位至少有1个空格,否则无法制作.");	
					cm.dispose();	
                } else{
					...
					var weapon = new Array("狂龙闪电剑#k - 等级. 110 单手剑#b", "狂龙怒斩#k - 等级. 110 单手斧#b", "狂龙地锤#k - 等级. 110 单手锤#b", "飞龙巨剑#k - 等级. 110 双手剑#b", "炼狱魔龙斧#k - 等级. 110 双手斧#b", "金龙轰天锤#k - 等级. 110 双手锤#b",
							"盘龙七冲枪#k - 等级. 110 火枪#b", "血龙神斧#k - 等级. 110 矛#b", "龙背刃#k - 等级. 100 双手剑#b");
                ...
                var selStr = "很好，那么你想做哪一个？？#b";
                var weapon = new Array("佘太君龙杖#k - 等级. 108 短杖#b", "黑精灵王杖#k - 等级. 110 长杖#b", "寒冰之杖#k - 等级. 130 短杖#b", "爆炎之杖#k - 等级. 130 短杖#b", "剧毒之杖#k - 等级. 130 短杖#b", "狂雷之杖#k - 等级. 130 短杖#b");//, "寒冰之杖#k - 等级. 130 短杖#b", "爆炎之杖#k - 等级. 130 短杖#b", "剧毒之杖#k - 等级. 130 短杖#b", "狂雷之杖#k - 等级. 130 短杖#b"
                for (var i = 0; i < weapon.length; i++) {
                    selStr += "\r\n#L" + i + "# " + weapon[i] + "#l";
                }
                cm.sendSimple(selStr);
        ...
        if (selectedType == 1) { //warrior weapon
            var itemSet = new Array(1302059, 1312031, 1322052, 1402036, 1412026, 1422028, 1432038, 1442045, 1402037);
            var matSet = new Array(new Array(1302056, 4000244, 4000245, 4005000), new Array(1312030, 4000244, 4000245, 4005000), new Array(1322045, 4000244, 4000245, 4005000), new Array(1402035, 4000244, 4000245, 4005000),
                    new Array(1412021, 4000244, 4000245, 4005000), new Array(1422027, 4000244, 4000245, 4005000), new Array(1432030, 4000244, 4000245, 4005000), new Array(1442044, 4000244, 4000245, 4005000), new Array(1402035, 4000244, 4000245, 4005000, 4005001, 4005002, 4005003, 4005004));
            var matQtySet = new Array(new Array(1, 20, 25, 8), new Array(1, 20, 25, 8), new Array(1, 20, 25, 8), new Array(1, 20, 25, 8), new Array(1, 20, 25, 8), new Array(1, 20, 25, 8), new Array(1, 20, 25, 8), new Array(1, 20, 25, 8), new Array(1, 60, 60, 10, 10, 10, 10, 10));
            var costSet = new Array(30000000, 30000000, 30000000, 30000000, 30000000, 30000000, 30000000, 30000000, 50000000);
            ...
            var costSet = new Array(25000000, 25000000);
            item = itemSet[selectedItem];
            mats = matSet[selectedItem];
            matQty = matQtySet[selectedItem];
            cost = costSet[selectedItem];
        } else if (selectedType == 3) { //magician weapon
            var itemSet = new Array(1372032, 1382036, 1372041, 1372039, 1372040, 1372042);
            var matSet = new Array(new Array(1372010, 4000244, 4000245, 4005001, 4005003), new Array(1382035, 4000244, 4000245, 4005001, 4005003), new Array(1372032, 4000244, 4000245, 4005000, 4005001, 4005002, 4005003, 4005004), new Array(1372032, 4000244, 4000245, 4005000, 4005001, 4005002, 4005003, 4005004), new Array(1372032, 4000244, 4000245, 4005000, 4005001, 4005002, 4005003, 4005004), new Array(1372032, 4000244, 4000245, 4005000, 4005001, 4005002, 4005003, 4005004));
            var matQtySet = new Array(new Array(1, 20, 25, 6, 2), new Array(1, 20, 25, 6, 2), new Array(1, 50, 50, 30, 30, 30, 30, 30), new Array(1, 50, 50, 30, 30, 30, 30, 30), new Array(1, 50, 50, 30, 30, 30, 30, 30), new Array(1, 50, 50, 30, 30, 30, 30, 30));
            var costSet = new Array(25000000, 25000000, 80000000, 50000000, 50000000, 80000000);
            item = itemSet[selectedItem];
            mats = matSet[selectedItem];
            matQty = matQtySet[selectedItem];
            cost = costSet[selectedItem];
            ...
            var costSet = new Array(30000000, 30000000, 30000000);
            item = itemSet[selectedItem];
            mats = matSet[selectedItem];
            matQty = matQtySet[selectedItem];
            cost = costSet[selectedItem];
            ...
            var costSet = new Array(30000000, 30000000);
            item = itemSet[selectedItem];
            mats = matSet[selectedItem];
            matQty = matQtySet[selectedItem];
            cost = costSet[selectedItem];
