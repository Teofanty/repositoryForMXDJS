...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#L1##d四维/攻/魔 +1 #v1112915##k#l\r\n";
            ...
            if (cm.haveItem(1112434, 1) && cm.haveItem(4000313, 250) && cm.haveItem(4011004, 10) && cm.haveItem(4021007, 10) && cm.haveItem(4011006, 10) && cm.haveItem(4021005, 10) && cm.haveItem(4021002, 10) && cm.haveItem(4251202, 1) && cm.haveItem(4001083, 1) && cm.haveItem(4001084, 3) && cm.haveItem(4001085, 3) && cm.haveItem(4000175, 3) && cm.haveItem(4001126, 2500) && cm.haveItem(4000487, 10) && cm.haveItem(4002000, 100) && cm.haveItem(4002001, 25) && cm.haveItem(4002002, 5) && cm.haveItem(4002003, 3) && cm.haveItem(4031559, 30) && cm.getMeso() >=30000000) {
                ...
                cm.sendOk("合成失败！材料不足！#v4000313#*250个 #v1112434#*1个 #v4011004#*10个 #v4021007#*10个 #v4011006#*10个 #v4021005#*10个 #v4021002#*10个 #v4251202#*1个 #v4001083#*1个 #v4001084#*3个 #v4001085#*3个 #v4000175#*3个 #v4001126#*2500个 #v4000487#*10个 #v4002000#*100个 #v4002001#*25个 #v4002002#*5个 #v4002003#*3个 #v4031559#*30个 3000万金币");
                cm.dispose();
            }
        } else if (selection == 6) {
