...
function action(mode, type, selection) {
	...
	return;
		 ...
		 if (cm.getPlayer().getClient().getChannel() != 1) {//限制频道
	...
	if (num == 0) {
		...
		if(cm.getKegs() * 30 + num >= 3000){
			cm.spawnMobOnMap(9420549,1,2651,574,100000200);//地图生怪
			cm.spawnMobOnMap(9400014,1,2700,570,100000200);//地图生怪
		}
