        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                if (cm.getPlayer().getCSPoints(2) / 100 == 0) {
                    ...
                    beauty = 1;
                    cm.sendGetNumber("请输入#r抵用卷#k兑换#b#v4031250##z4031250##k的数量:\r\n#b比例 - (#r100 = 1#b)\r\n你的账户信息 - \r\n    抵用卷数量: #r" +
                ...
                if (cm.haveItem(4031250) == 0) {
                    cm.sendNext("您的帐户#v4031250##z4031250#数量不足兑换抵用卷。");
                    status = -1;
                } else {
                    beauty = 2;
                    cm.sendGetNumber("请输入#b#v4031250##z4031250##k兑换#r抵用卷#k的数量:\r\n#b比例 - (#r1 = 100#b)\r\n你的账户信息 - \r\n    抵用卷数量: #r" +
                ...
                if (cm.haveItem(4031250) == 0) {
                    ...
                    beauty = 4;
                    cm.sendGetNumber("请输入#b#v4031250##z4031250##k兑换#r点卷#k的数量:\r\n#b比例 - (#r2 = 1#b)\r\n你的账户信息 - \r\n点卷数量: #r" +
...
*/
                    ...
                    cm.sendNext("兑换" + selection + "个#v4031250##z4031250##v4031250# 需要#r " + (selection * 300) + "#k抵用卷。您没有足够的抵用卷。");
                    cm.dispose();
                }
            } else if (beauty == 2) {
                if (cm.haveItem(4031250, selection)) {
                    cm.gainItem(4031250, -selection);
					cm.getPlayer().modifyCSPoints(2, +300 * selection, true);
                    cm.sendOk("您成功将#v4031250##z4031250##v4031250# x #r" + selection + " #k换为#r " + (300 * selection) + " #k抵用卷。");
                } else {
                ...
                if (cm.haveItem(4031250, selection)) {
                    cm.gainItem(4031250, -selection);
                     cm.getPlayer().modifyCSPoints(2, +Math.floor(1 * selection), true);
                    cm.sendOk("您成功将#v4031250##z4031250##v4031250# x #r" + selection + " #k换为#r " + Math.floor(1 * selection) + " #k抵用券。");
                } else {
                ...
                if (cm.haveItem(4031250, 2 * selection)) {
                    ...
                    cm.getPlayer().modifyCSPoints(2, +Math.floor(1 * selection), true);
                    cm.sendOk("您成功将4444#v4031250##z4031250##v4031250# x #r" + (2 * selection) + " #k换为#r " + Math.floor(3 * selection) + " #k点卷。");
                } else {
                    cm.sendNext("您的输入的数量错误，无法兑换抵用卷。");
                    cm.dispose();
                }
