    ...
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			if(cm.getPlayer().getzxsj() >= 60 && cm.getPlayer().getBossLog("zxsj") == 0){
				text += "#L2##r"+完成红+"在线时间超过60分钟！"+完成+"#v2022003#*100个#v4001126#*50个#v5390002#*3个. #l\r\n\r\n\r\n"
			...
			if(cm.getPlayer().getzxsj() >= 120 && cm.getPlayer().getBossLog("zxsj") == 1){
				text += "#L3##r"+完成红+"在线时间超过120分钟！"+完成+"#v2022000#*100个#v2022070#*1个#l\r\n\r\n\r\n"
			...
			if(cm.getPlayer().getzxsj() >= 180 && cm.getPlayer().getBossLog("zxsj") == 2){
				text += "#L4##r"+完成红+"在线时间超过180分钟！"+完成+"10W金币#l\r\n\r\n\r\n"
			...
			if(cm.getPlayer().getzxsj() >= 300 && cm.getPlayer().getBossLog("zxsj") == 4){
				text += "#L6##r"+完成红+"在线时间超过300分钟！"+完成+"#v5040000#*2个#v5440000#*1000#l\r\n\r\n\r\n\r\n"
