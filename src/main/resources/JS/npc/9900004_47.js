...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text +="大家好,我是合成NPC\r\n#r60%#k的概率强化一次饰品，全属性+1，攻击力+1，HP+5，MP+5\r\n#r10%#k的概率强化一次饰品，全属性+2，攻击力+2，hp+15,mp+15\r\n";
            text +="#L1##d100个#v4020009##z4020009#兑换1个#v1112915#4维属性+1 攻/魔+1 HP/MP+15#k#l\r\n";
            text +="#L2##d50个#v4020009##z4020009#60%概率强化饰品#k#l\r\n";
			text +="#L3##d75个#v4020009##z4020009#60%概率强化饰品#k#l\r\n";
		...
		//toDrop. setWdef(2);//物理防御
		//toDrop. setMdef(2);//魔法防御
		//toDrop. setAcc(2);//命中
		//toDrop. setAvoid(2);//回避
		//toDrop. setHands(2);//手技
		//toDrop. setSpeed(2);//移动
		//toDrop. setJump(2);//跳跃
		...
		cm.getC().getSession().write(CWvsContext.InventoryPacket.addInventorySlot(type, toDrop, false)); //刷新背包
		    ...
		    cm.sendOk("#b请保证装备栏位至少有1个空格,否则无法抽奖.");
		    cm.dispose();
		} else if (cm.haveItem(1112915, 1)&& cm.haveItem(4011004, 3) && cm.haveItem(4021007, 3) && cm.haveItem(4011006, 3) && cm.haveItem(4021005, 3) && cm.haveItem(4021002, 3) && cm.haveItem(4005000, 3) && cm.haveItem(4005001, 3) && cm.haveItem(4005002, 3) && cm.haveItem(4005003, 3) && cm.haveItem(4011004, 3) && cm.haveItem(4000029, 100) && cm.haveItem(4001126, 1000) && cm.haveItem(4002000, 30) && cm.haveItem(4170005, 10) && cm.haveItem(4001158, 15) && cm.getMeso() >=5000000) {
