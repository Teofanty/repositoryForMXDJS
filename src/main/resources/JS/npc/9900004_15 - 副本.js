...
Array(   
			...
			Array(1302079,10,1,1),//战刃(单手剑)
			Array(1302001,1000,1,1),//锯子
			Array(1312012,500,1,1),//呼啦圈
			Array(1322006,1000,1,1),//钢管
			Array(1322053,100,1,1),//皇丈
			Array(1322059,100,1,1),//皇冠锤
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (cm.haveItem(4000487, 1)) {
            cm.sendYesNo("只要你有#v4000487#，就可以随机可以获得以下物品，99%获得\r\n\#b是否消耗 #g1#r个#b#v4000487#\r\n来一发？?"+selStr);
        } else {
            cm.sendOk("只要你有#v4000487#，就可以随机获得以下物品，99%获得\r\n\#b是否消耗 #g1#r个#b#v4000487#\r\n来一发？?"+selStr);
            cm.safeDispose();
        }
    } else if (status == 1) {
