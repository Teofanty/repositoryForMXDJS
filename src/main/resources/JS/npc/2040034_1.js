...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text +=" 兑换玩具城副本达人#v1142002# （四维+1）\r\n 需要50张玩具城副本邮票#v4031559#\r\n";
            text += "#L1##r兑换#v1142002#玩具城副本达人\r\n";
            //text += "#v1112915#*1 #v4031559#*25 #v4001222#*25 #v4001223#*10 #v4001224#*10 #v4001225#*10 #v4021000#*5 #v4021001#*5 #v4021002#*5 #v4021003#*5 #v4021004#*5 #v4021005#*5 #v4021006#*5 #v4021007#*5 +金币200万\r\n";
            cm.sendSimple(text);
        } else if (selection == 1) {
