...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			tt += "#L10#"+红色箭头+"挑战BOSS大海兽#l\t \r\n\r\n"	
			tt += "#k=============================================="
			tt += "#L12##b"+红色箭头+"#e#rLv10.英语学院副本#l  #L13##b"+红色箭头+"#e#d#rLv10.月妙组队副本#k#l\r\n"
			tt += "#L14#"+红色箭头+"#d#rLv21.废弃组队副本#l  #L15#"+红色箭头+"#d#rLv35.玩具组队副本#l\r\n"
			tt += "#L16#"+红色箭头+"#d#rLv51.天空组队副本#l  #L17#"+红色箭头+"#d#rLv55.海盗组队副本#l\r\n"
			tt += "#L18#"+红色箭头+"Lv70.罗密欧与朱丽叶组队副本#l\r\n"
			tt += "#L19#"+红色箭头+"#d#rLv100.毒物组队副本#l\r\n"
			tt += "#L20#"+红色箭头+"#d#rLv130.人偶师组队副本#l\r\n"
			tt += "#L21#"+红色箭头+"#d#rLv120.天关副本[可单人]\r\n"
			tt += "#L22#"+红色箭头+"#d#rLv120.挑战绯红副本#k#l\r\n"
			tt += "#L23#"+红色箭头+"#d#rLv30.怪物嘉年华(组队对抗副本.最低2V2)\r\n"
			tt += "#L24#"+红色箭头+"#d#r遗址公会对抗战(家族副本)#l\r\n"
            cm.sendSimple(tt);
        } else if (status == 1) {
            if (selection == 0) {
