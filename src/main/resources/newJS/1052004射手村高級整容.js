...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendNext("嘿~！你好，欢迎来到#b射手村整形会员中心#k。如果你有#b射手村整形手术高级会员卡#k，我可以为你进行整形手术。\r\n\#L2##b进行整形手术#k(使用#b射手村整形手术高级会员卡#k)#l");
    } else if (status == 1) {
        ...
        cm.askAvatar("我可以改变你的脸型,让它比现在看起来漂亮. 你为什么不试着改变它下? 如果你有#b射手村整形手术高级会员卡#k,我将会帮你改变你的脸型,那么选择一个你想要的新脸型吧!", facetype);
    } else if (status == 2){
