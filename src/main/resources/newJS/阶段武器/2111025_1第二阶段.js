...
//定义各职业新旧武器
//战士新武器列表
var zhanshi = [1302030, 1412011, 1422014, 1432012, 1442024, 1302030, 1412011, 1422014];
//战士新武器属性
var propertyZS = [50, 50, 50, 58, 58, 53, 53.53];
//战士前置武器列表
var zhanshi1 = [1302105, 1312039, 1322065, 1432050, 1442071, 1402053, 1412035, 1422039];

//飞侠新武器列表
var feixia = [1332025, 1472032];
//飞侠新武器属性
var propertyFX = [50, 20];
//飞侠前置武器列表
var feixia1 = [1332081, 1472077];
...
//法师前置武器列表
var fashi1 = [1372046, 1382062];

//弓手新武器列表
var gongshou = [1452022, 1462019];
//弓手新武器属性
var propertyGS = [49, 53];
//弓手前置武器列表
var gongshou1 = [1452062, 1462056];

//海盗新武器列表
var haidao = [1482020, 1492020];
//海盗新武器属性
var propertyHD = [37, 39];
//海盗前置武器列表
var haidao1 = [1482029, 1492030];

//需求物品列表及对应数量（一一对应关系）
var needItems = [4002001, 4000007, 4000013];
var needAmout = [20, 200, 200];
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (jobIndex < 0 || (jobIndex > jobNames.length - 1)) {
