...
var status = -1;
var itemList = Array(
	Array(1002448,100,200, "1"),
	Array(1002543,100,200, "2"),
	Array(1002583,100,200, "3"),
	Array(1002589,100,200, "4"),
	Array(1002609,100,200, "5"),
	Array(1002665,100,200, "6"),
	Array(1002695,100,200, "7"),
	Array(1002760,100,200, "8"),
	Array(1002761,100,200, "9"),
	Array(1002789,100,200, "10")
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "您好，请选择您需要兑换的物品                          ★#r豆豆点：#r" + cm.getPlayer().getBeans() + "#k点\r\n";
