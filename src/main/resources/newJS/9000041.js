...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            gsjb +="#L1##b点券兑换枫叶 #fUI/Basic/BtHide3/mouseOver/0# #b比例 - (#r1 = 1#b)#l\r\n\r\n";
            gsjb +="#L3##b枫叶换点券 #fUI/Basic/BtHide3/mouseOver/0# #b比例 - (#r2 = 1#b)#l\r\n\r\n";
            ...
            if (selection == 0) {
                if (cm.getPlayer().getCSPoints(2) / 100 == 0) {
                    ...
                    beauty = 1;
                    cm.sendGetNumber("请输入#r抵用卷#k兑换#b#z4001126##k的数量:\r\n#b比例 - (#r100 = 1#b)\r\n你的账户信息 - \r\n    抵用卷数量: #r" +
            ...
            if (beauty == 1) {
                if (selection <= 0) {
                    ...
                    cm.sendOk("您成111功将 #r " + (selection * 300) + " #k抵用卷 兑换成#v4001126# x #r" + selection + " #k")
                } else {
                    cm.sendNext("兑换" + selection + "个#z4001126##v4001126# 需要#r " + (selection * 300) + "#k抵用卷。您没有足够的抵用卷。");
                    cm.dispose();
                }
            } else if (beauty == 2) {
                if (cm.getPlayer().getCSPoints(1), selection) {
                    ...
                    cm.gainItem(4001126, selection);
                    cm.sendOk("您成功将#r " + (selection) + " 点卷#k换为#z4001126##v4001126# x #r" + (selection) + " #k枫叶。");
                } else {
                ...
                if (cm.haveItem(4001126, 1 * selection)) {
                    cm.gainItem(4001126, - (1 * selection));
                    cm.gainDJ(+Math.floor(1 * selection));
                    cm.sendOk("您成功将#z4001126##v4001126# x #r" + (1 * selection) + " #k换为#r " + Math.floor(1 * selection) + " #k点卷。");
                } else {
